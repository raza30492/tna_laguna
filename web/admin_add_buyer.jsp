                                    ...
                                    <form name="form" action="add_buyer" method="post" onsubmit="return addBuyer()" >
                                        ...
                                        <table class="table-bordered" id="bordered-table" style="width: 80%; margin: 20px auto" >
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" min="0" name="activity1" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>${requestScope.activityNames[1]}</td>
                                                <td><input type="number" min="0" name="activity2" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>${requestScope.activityNames[2]}</td>
                                                <td><input type="number" min="0" name="activity3" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>${requestScope.activityNames[3]}</td>
                                                <td><input type="number" min="0" name="activity4" value="" class="form-control align-center"class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                <td>${requestScope.activityNames[4]}</td>
                                                <td><input type="number" min="0" name="activity5" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>6</td>
                                                <td>${requestScope.activityNames[5]}</td>
                                                <td><input type="number" min="0" name="activity6" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>7</td>
                                                <td>${requestScope.activityNames[6]}</td>
                                                <td><input type="number" min="0" name="activity7" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>8</td>
                                                <td>${requestScope.activityNames[7]}</td>
                                                <td><input type="number" min="0" name="activity8" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>9</td>
                                                <td>${requestScope.activityNames[8]}</td>
                                                <td><input type="number" min="0" name="activity9" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>10</td>
                                                <td>${requestScope.activityNames[9]} </td>
                                                <td><input type="number" min="0" name="activity10" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>11</td>
                                                <td>${requestScope.activityNames[10]}</td>
                                                <td><input type="number" min="0" name="activity11" value="" class="form-control align-center" /></td>
                                            </tr>
                                            <tr>
                                                <td>12</td>
                                                <td>${requestScope.activityNames[11]}</td>
                                                <td><input type="number" min="0" name="activity12" value="" class="form-control align-center" /></td>
                                            </tr>
                                        </table>
