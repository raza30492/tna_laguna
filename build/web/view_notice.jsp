            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div id="admin-content">
                        <div class="btn-group">
                            <a role="button" class="btn btn-primary active" href="view_notice?redirect=one&curr=1">View Notice</a>
                        ...
                        <div style="width: 80%;margin: 20px auto" >
                            ...
                            <c:if test="${requestScope.total != 0}" >
                                <table class="table-bordered" id="bordered-table" style="width:100%">
                                    <tr>
                                        <th class="align-center" width="70%">Notice</th>
                                        <th class="align-center" width="30%">Published on</th>
                                    </tr>
